...
/**
 * Checks to see if the ant moved
 * @return if true if the ant moved
 */
...
/**
 * Scans to see if the ant is alive
 * @return whether the ant died or not
 */
...
/**
 * Checks to see if a doodlebug was made
 * @return true if a doodlebug is successfully made
 */
 ...
 * @return if true if the doodlebug moved
 */
 ...
 * @return if a doodlebug can breed
 */
...
/**
 * Checks to see if the doodlebug ate an ant
 * @return a boolean of whether or not the doodlebug ate an ant
 */
...
/**
 * Scans to see if the doodlebug is alive
 * @return whether the doodlebug died or not
 */
...
/**
 * Destroys the results of the tests
 */
Tests2::~Tests2() {
